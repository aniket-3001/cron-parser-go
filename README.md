...
starting instants are generated in the page, handed to both, and every answer compared — the same
harness that runs in CI, on inputs neither side chose. A quarter of generated expressions are
